...
3. **One more thing about plotting.** In a later class, we will introduce a
   ...
   grammar of data visualization that composable is used r you combine together to quickly make
   visualizations.
...
TODO: show examples of DGE and explain that we are finding genes whose
mean expression is different (ie. "not the same") across groups.
